...
void data_handle(unsigned short offset)
{
    ...
    // tft.printf("%d+%02x ",offset,cmd_type);
    ...
    switch(cmd_type)
    {
        ...
        case WEATHER_OPEN_CMD:                                  //打开天气服务返回
            ...
            // tft.println("WEATHER_OPEN_CMD");
        break;
    
        case WEATHER_DATA_CMD:                                  //天气数据下发
            tft.println("WEATHER_DATA_CMD");
            total_len = (wifi_data_process_buf[offset + LENGTH_HIGH] << 8) | wifi_data_process_buf[offset + LENGTH_LOW];
        ...
        default:tft.setTextColor(ST77XX_GREEN);tft.println("err");tft.setTextColor(ST77XX_BLACK);break;
    }
}
