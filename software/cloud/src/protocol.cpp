...
extern  int humidity_indoor;

extern  int temp_outdoor;
extern  int humidity_outdoor;
...
void all_data_update(void)
{
    ...
    mcu_dp_value_update(DPID_TEMP_CURRENT, temp_indoor);
    mcu_dp_value_update(DPID_HUMIDITY_VALUE, humidity_indoor);
}
...
void weather_data_user_handle(char *name, unsigned char type, const unsigned char *data, char day)
{
    ...
    {
        humidity_outdoor = value_int;
      
        //tft.setTextColor(ST77XX_WHITE);
        // tft.printf("temp:%d",humidity_outdoor);
